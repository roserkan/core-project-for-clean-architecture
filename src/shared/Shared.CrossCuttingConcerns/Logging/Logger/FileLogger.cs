...
using Serilog;
using Shared.CrossCuttingConcerns.Logging.Messages;
using Shared.CrossCuttingConcerns.Logging.Serilog.ConfigurationModels;
using Shared.CrossCuttingConcerns.Logging.Serilog;

namespace Shared.CrossCuttingConcerns.Logging.Logger;
