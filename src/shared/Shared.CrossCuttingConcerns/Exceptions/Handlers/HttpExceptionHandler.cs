...
using Shared.CrossCuttingConcerns.Exceptions.HttpProblemDetails;
...
public class HttpExceptionHandler : ExceptionHandler
{
    ...
    protected override Task HandleException(DomainException domainException)
    {
        Response.StatusCode = StatusCodes.Status400BadRequest;
        string details = new BusinessProblemDetails(domainException.Message).AsJson();
        return Response.WriteAsync(details);
    }
